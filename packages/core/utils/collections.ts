...
function getEntryPoint(archetype: Archetype): string {
  switch (archetype.type) {
    case "blog-content":
      return "@goulvenclech/astrolingo/pages/blog.astro"
    case "docs-content":
      return "@goulvenclech/astrolingo/pages/docs-content.astro"
    case "docs-openapi":
      return "@goulvenclech/astrolingo/pages/docs-openapi.astro"
  }
}
